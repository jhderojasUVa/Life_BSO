 ...
 * @property {RefObject<HTMLVideoElement | null>} videoRef - The ref to the video element.
 ...
 * @returns {JSX.Element} The VideoFeed component.
 */
const VideoFeed = ({ videoRef, className }: VideoFeedProps) => {
